      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="<?php  echo base_url('#') ?>" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?php  echo base_url('assets/dist/img/orang3.jpg') ?>" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php  echo base_url('welcome/index3') ?>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v3</p>
                </a>
              </li>
            ...
            <div class="card">
              <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                  ...
                  <a href="<?php  echo base_url('javascript:void(0);') ?>">View Report</a>
                </div>
              </div>
              <div class="card-body">
                <div class="d-flex">
          ...
          <div class="col-lg-6">
            ...
            <div class="card">
              <div class="card-header border-0">
                ...
                <div class="card-tools">
                  <a href="<?php  echo base_url('#') ?>" class="btn btn-sm btn-tool">
                    <i class="fas fa-download"></i>
                  </a>
                  <a href="<?php  echo base_url('#') ?>" class="btn btn-sm btn-tool">
                    <i class="fas fa-bars"></i>
