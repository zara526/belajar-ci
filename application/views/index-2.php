      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="<?php echo base_url('#'); ?>" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?php echo base_url('assets/dist/img/orang2.png'); ?>" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('aasets/pages/layout/fixed-topnav.php'); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Fixed Navbar</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('assets/pages/UI/icons.php'); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Icons</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('application/views/starter.php'); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Starter Page</p>
                </a>
              </li>
                ...
                <div class="card-tools">
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                      <a href="<?php echo base_url('#'); ?>" class="dropdown-item">Action</a>
                      <a href="<?php echo base_url('#'); ?>" class="dropdown-item">Another action</a>
                      <a href="<?php echo base_url('#'); ?>" class="dropdown-item">Something else here</a>
                      <a class="dropdown-divider"></a>
                      <a href="<?php echo base_url('#'); ?>" class="dropdown-item">Separated link</a>
                    </div>
                  </div>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        <div class="direct-chat-infos clearfix">
                          <span class="direct-chat-name float-left">Askandar Young</span>
                          <span class="direct-chat-timestamp float-right">23 Jan 2:00 pm</span>
                        </div>
                        <!-- /.direct-chat-infos -->
                        <img class="direct-chat-img" src="<?php echo base_url('assets/dist/img/orang2.jpg'); ?>" alt="message user image">
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
                          Assalamu'alaikum sohib semua
                        </div>
                        <!-- /.direct-chat-text -->
                      </div>
                      <!-- /.direct-chat-msg -->
                      ...
                      <div class="direct-chat-msg right">
                        <div class="direct-chat-infos clearfix">
                          <span class="direct-chat-name float-right">Alana Maudia</span>
                          <span class="direct-chat-timestamp float-left">23 Jan 2:05 pm</span>
                        </div>
                        <!-- /.direct-chat-infos -->
                        <img class="direct-chat-img" src="<?php echo base_url('assets/dist/img/orang1.png'); ?>" alt="message user image">
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
                          Sini-sini ke website aku
                        </div>
                        <!-- /.direct-chat-text -->
                      </div>
                      <!-- /.direct-chat-msg -->
                      ...
                      <div class="direct-chat-msg">
                        ...
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
                          Website kita lan...nanti ga aku beliiin tahu bulat lo
                        </div>
                        <!-- /.direct-chat-text -->
                      </div>
                      <!-- /.direct-chat-msg -->
                      ...
                      <div class="direct-chat-msg right">
                        ...
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
                          jangan dung, beliin ya 100.000 aja kok
                        </div>
                        <!-- /.direct-chat-text -->
                      </div>
                      <!-- /.direct-chat-msg -->
                      ...
                      <ul class="contacts-list">
                        <li>
                          <a href="<?php echo base_url(''); ?>#">
                            <img class="contacts-list-img" src="<?php echo base_url('assets/dist/img/orang2.jpg'); ?>" alt="User Avatar">
                        ...
                        <li>
                          <a href="<?php echo base_url(''); ?>#">
                            <img class="contacts-list-img" src="<?php echo base_url('assets/dist/img/orang1.png'); ?>" alt="User Avatar">
                ...
                <div class="card">
                  ...
                  <div class="card-body p-0">
                    <ul class="users-list clearfix">
                      <li>
                        <img src="<?php echo base_url('assets/dist/img/orang2.jpg'); ?>" alt="User Image">
                        <a class="users-list-name" href="<?php echo base_url('#'); ?>">Askandar Young</a>
                        <span class="users-list-date">Today</span>
                      </li>
                      <li>
                        <img src="<?php echo base_url('assets/dist/img/orang3.jpg'); ?>" alt="User Image">
                        <a class="users-list-name" href="<?php echo base_url('#'); ?>">Norman Alfarizi</a>
                        <span class="users-list-date">Yesterday</span>
                      </li>
                      <li>
                        <img src="<?php echo base_url('assets/dist/img/orang4.jpg'); ?>" alt="User Image">
                        <a class="users-list-name" href="<?php echo base_url('#'); ?>">Amunaraaa</a>
                        <span class="users-list-date">12 Jan</span>
                      </li>
                      <li>
                        <img src="<?php echo base_url('assets/dist/img/orang5.jpg'); ?>" alt="User Image">
                        <a class="users-list-name" href="<?php echo base_url('#'); ?>">Gledek Abang</a>
                        <span class="users-list-date">12 Jan</span>
                      </li>
                      <li>
                        <img src="<?php echo base_url('assets/dist/img/orang6.jpg'); ?>" alt="User Image">
                        <a class="users-list-name" href="<?php echo base_url('#'); ?>">Monmoncans</a>
                        <span class="users-list-date">13 Jan</span>
                      </li>
                      <li>
                        <img src="<?php echo base_url('assets/dist/img/orang1.png'); ?>" alt="User Image">
                        <a class="users-list-name" href="<?php echo base_url('#'); ?>">Alana Maudia</a>
                        <span class="users-list-date">14 Jan</span>
                      </li>
                      <li>
                        <img src="<?php echo base_url('assets/dist/img/orang7.jpg'); ?>" alt="User Image">
                        <a class="users-list-name" href="<?php echo base_url('#'); ?>">Firmansarung_pridee</a>
                        <span class="users-list-date">15 Jan</span>
                      </li>
                      <li>
                        <img src="<?php echo base_url('assets/dist/img/orang8.jpg'); ?>" alt="User Image">
                        <a class="users-list-name" href="<?php echo base_url('#'); ?>">Nadia_cool</a>
                        <span class="users-list-date">15 Jan</span>
                      </li>
                    </ul>
                    <!-- /.users-list -->
                  ...
                  <div class="card-footer text-center">
                    <a href="<?php echo base_url('javascript:'); ?>">View All Users</a>
                  </div>
                  <!-- /.card-footer -->
                </div>
                <!--/.card -->
            ...
            <div class="card">
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                    <tr>
                      <td><a href="<?php echo base_url('assets/pages/examples/invoice.php'); ?>">OR9842</a></td>
                    ...
                    <tr>
                      <td><a href="<?php echo base_url('assets/pages/examples/invoice.php'); ?>">OR1848</a></td>
                    ...
                    <tr>
                      <td><a href="<?php echo base_url('assets/pages/examples/invoice.php'); ?>">OR7429</a></td>
                      <td>iPhone 6 Plus</td>
              ...
              <div class="card-footer clearfix">
                <a href="<?php echo base_url('javascript:void(0)'); ?>" class="btn btn-sm btn-info float-left">Place New Order</a>
                <a href="<?php echo base_url('javascript:void(0)'); ?>" class="btn btn-sm btn-secondary float-right">View All Orders</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
          ...
          <div class="col-md-4">
            ...
            <div class="card">
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="<?php echo base_url(''); ?>javascript:void(0)" class="product-title">Samsung TV
                  ...
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="<?php echo base_url('javascript:void(0)'); ?>" class="product-title">Bicycle
                  ...
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="<?php echo base_url('javascript:void(0)'); ?>" class="product-title">
                  ...
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="<?php echo base_url('javascript:void(0)'); ?>" class="product-title">PlayStation 4
              ...
              <!-- /.card-body -->
              <div class="card-footer text-center">
                <a href="<?php echo base_url('javascript:void(0)'); ?>" class="uppercase">View All Products</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
