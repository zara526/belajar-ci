	...
	<div class="container login-container" style="margin-top: 10%;">
		...
		<div class="row">
			<div class="col-md-6 ads">
				<img src="<?php echo base_url('assets\dist\img\AdminLTELogo.png') ?>" alt="profile_img" style="padding-top: 15px;" height="350px" width="300px;">
			</div>
			<div class="col-md-6 login-form" style="background-color: #ecd4ff">
				<h3>Register</h3>
				<form action="<?= base_url('auth/daftar') ?>" method="POST">
					<div class="form-group">
						<input type="text" class="form-control" name="id" placeholder="Id-mu">
					</div>
					<div class="form-group">
